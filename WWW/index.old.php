...
<!DOCTYPE html>
<html>
    <?php //include('/var/www/html/libraryheader.html'); ?>
	<head>
        ...
        <link rel="stylesheet" type="text/css" media="screen" href="/newpage/css/main.css">
	</head>
    
	<body style="background-image:'/newpage/images/bkgd.gif'">
        
        <?php //include('/var/www/html/librarytop.html'); ?>
		<div class="container" style="width:1034px; background-color: white; border: none; padding: 10px 20px 5px 20px">
            <!--
			<div class="headerbar"><center><h1>Lab Availability</h1></div>
            ...
            <div id="page_header">
                ...
                <div id="logo">
                    <a href="/"><img src="http://www.newpaltz.edu/images/spacer.gif" width="271" height="98" border="0"></a><br>
                </div>
                <div id="login">
                     <!--<h1>LOGIN</h1> --> <br>
                     <a href="http://www.newpaltz.edu/people/" target="_blank">People-Finder</a>  &nbsp;|&nbsp;  
                     <a href="http://my.newpaltz.edu" class="nav">my.newpaltz.edu</a>  &nbsp;|&nbsp;  
                     <a href="http://www.newpaltz.edu" class="nav">Campus Home</a><br>
                </div>
                <br clear="all">
            </div>
			<div class="content" style="width:994px; background-color:white;">
				<div class="row">
        ...
        <?php //include('/var/www/html/libraryfooter.html'); ?>
	</body>
</html>
