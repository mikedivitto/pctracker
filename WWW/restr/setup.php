...
{*/
	...
	$sqld="CREATE TABLE " . $DB_USERINFO . " (ID INT(10) NOT NULL AUTO_INCREMENT, EMAIL TEXT NOT NULL, PASSWORD TEXT NOT NULL, LEVEL INT(11) NOT NULL, NICKNAME TEXT NOT NULL, PRIMARY KEY(ID))";
